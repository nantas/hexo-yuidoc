...
hexo.extend.helper.register('yuidoc_example', helpers.yuidoc_example);
...
hexo.extend.tag.register('crosslink', tag.crosslink, {escape: false});
hexo.extend.tag.register('crossLink', tag.crosslink, {escape: false});
hexo.extend.tag.register('cross_link', tag.crosslink, {escape: false});